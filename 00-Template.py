"""
https://huggingface.co/maddes8cht/NousResearch-Nous-Capybara-3B-V1.9-gguf
REPO: maddes8cht/NousResearch-Nous-Capybara-3B-V1.9-gguf
...
convHistory = ''
convHistory = ''
mrepo = 'maddes8cht/NousResearch-Nous-Capybara-3B-V1.9-gguf'
modelfile = "models/NousResearch-Nous-Capybara-3B-V1.9-Q5_K_M.gguf"
modeltitle = "NousResearch-Nous-Capybara"
modelparameters = '3B'
model_is_sys = False
modelicon = '🚀'
imagefile = 'https://justfunfacts.com/wp-content/uploads/2017/12/capybara.jpg'
...
def combine(a, b, c, d,e,f):
    ...
    for character in llm(prompt, 
                ...
                stop=["<|im_end|>", "</s>","<|endoftext|>"], #'<|im_end|>'  '#'  '<|endoftext|>'
